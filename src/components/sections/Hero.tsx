      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            Your customers are telling you how they feel, the challenge is
            hearing it. NeuroFlow AI analyzes emotions in real time to spot
            frustration early, predict churn before it happens, and uncover
            opportunities to delight customers. With clear dashboards and
            actionable insights, your team can shift from reactive support to
            proactive growth.
          </Paragraph>
